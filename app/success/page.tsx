...
import SuccessDisclosure from "../../components/successDisclosure";
...
async function success({
  ...
  return (
    <main className="mx-auto flex min-h-screen justify-center overflow-hidden bg-gradient-to-r from-[#A9F1DF] to-[#FFBBBB]">
      {/* <Head>
